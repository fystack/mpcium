...
func TestCKDSigning(t *testing.T) {
	...
	t.Run("KeyGenerationForSigning", func(t *testing.T) {
		testKeyGenerationForCKDSigning(t, suite)
	})

	// Test signing with all nodes
	t.Run("CKDSigningAllNodes", func(t *testing.T) {
		testCKDSigningAllNodes(t, suite)
	})
...
func testKeyGenerationForCKDSigning(t *testing.T, suite *E2ETestSuite) {
...
func testCKDSigningAllNodes(t *testing.T, suite *E2ETestSuite) {
	...
	for _, walletID := range suite.walletIDs {
		...
		for i, message := range testMessages {
			...
			t.Run(fmt.Sprintf("ECDSA_%s_%d", walletID, i), func(t *testing.T) {
				testCKDECDSASigningWithSharedListener(t, suite, walletID, message, signingResults)
			})

			// Test EdDSA signing
			t.Run(fmt.Sprintf("EdDSA_%s_%d", walletID, i), func(t *testing.T) {
				testCKDEdDSASigningWithSharedListener(t, suite, walletID, message, signingResults)
			})
		}
	}
...
func testCKDECDSASigningWithSharedListener(t *testing.T, suite *E2ETestSuite, walletID, message string, signingResults map[string]*event.SigningResultEvent) {
...
func testCKDEdDSASigningWithSharedListener(t *testing.T, suite *E2ETestSuite, walletID, message string, signingResults map[string]*event.SigningResultEvent) {
